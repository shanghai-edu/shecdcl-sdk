...
func main() {
	...
	*/
	...
	//上海市核酸检测信息调用示例
	hsRes, err := c.GetSjHsjcjgcxSjgt("冯小骐", "360732197709013718")
	if err != nil {
		log.Fatalln(err)
		return
	}
	...
	*/
	...
	/*
				[
		  {
		   ...
		   "card_type": "1",
		   "card_type_name": "身份证",
		   "sample_orgname": "苏州第九人民医院",
		   "test_orgname": "苏州第九人民医院",
		   "sample_type": 1,
